...
- All deployment guides in `docs/`
- A buyer-facing install guide (`docs/install-guide.md`)
...
- [ ] `docs/deploy-bot.md` — bot deployment
- [ ] `docs/deploy-docker.md` — Docker full-stack deployment
